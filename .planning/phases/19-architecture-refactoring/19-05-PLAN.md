...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <resume-signal>Type one of: "approved", "failed-controls", "failed-displays", "failed-containers", "failed-decorative", or describe specific element that failed</resume-signal>
</task>
