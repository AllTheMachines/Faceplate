...
must_haves:
  truths:
    - "Element types are defined with discriminated unions"
    - "Elements array exists in store with CRUD operations"
    - "Canvas renders HTML container with CSS transform instead of Konva"
    - "Pan and zoom work on HTML canvas container"
  artifacts:
