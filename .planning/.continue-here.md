...
working JUCE WebView2 pattern discovered through INSTvst3 debugging (January 24-25, 2026).
...
<context>
The JUCE bridge fix was discovered through debugging INSTvst3 where knobs weren't working.
...
- EFXvst3: Volume knob works
- INSTvst3: All 5 knobs (gain + ADSR) work
</context>
