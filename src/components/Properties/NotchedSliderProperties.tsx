          ...
          <>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onUpdate({ labelPosition: e.target.value as NotchedSliderElementConfig['labelPosition'] })
                }
                className="w-full bg-gray-700 border border-gray-600 text-white rounded px-2 py-1.5 text-sm"
              >
          ...
          <>
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onUpdate({ valuePosition: e.target.value as NotchedSliderElementConfig['valuePosition'] })
                }
                className="w-full bg-gray-700 border border-gray-600 text-white rounded px-2 py-1.5 text-sm"
              >
                <option value="top">Top</option>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onUpdate({ valueFormat: e.target.value as NotchedSliderElementConfig['valueFormat'] })
                }
                className="w-full bg-gray-700 border border-gray-600 text-white rounded px-2 py-1.5 text-sm"
              >
