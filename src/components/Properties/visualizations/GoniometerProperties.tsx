...
import type { GoniometerElementConfig } from '../../../types/elements'
import type { PropertyComponentProps } from '../'

export function GoniometerProperties({ element, onUpdate }: PropertyComponentProps) {
  const config = element as GoniometerElementConfig
    ...
    <div className="space-y-6">
      ...
      <PropertySection title="Axis Lines">
        ...
        <div className="text-xs text-gray-500">
          L/R axes at 45° with M/S reference lines
        </div>
      </PropertySection>
