...
interface Props {
  element: StereoWidthMeterElementConfig
  onUpdate: (updates: Partial<any>) => void
}

export function StereoWidthMeterProperties({ element }: Props) {
  const updateElement = useStore((state) => state.updateElement)

  return (
    <div className="space-y-6">
      <div className="text-xs text-gray-400 uppercase tracking-wide">Stereo Width Meter</div>
