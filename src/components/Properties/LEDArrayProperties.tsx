import { LEDArrayElementConfig, ElementConfig } from '../../types/elements'
import { NumberInput, ColorInput, PropertySection } from './'

interface LEDArrayPropertiesProps {
  element: LEDArrayElementConfig
  onUpdate: (updates: Partial<ElementConfig>) => void
}

export function LEDArrayProperties({ element, onUpdate }: LEDArrayPropertiesProps) {
  return (
    <>
      {/* Value */}
      ...
      <PropertySection title="Glow">
        <label
          htmlFor="ledarray-glow-enabled"
          className="flex items-center gap-2 cursor-pointer select-none"
        >
          <input
            type="checkbox"
            id="ledarray-glow-enabled"
