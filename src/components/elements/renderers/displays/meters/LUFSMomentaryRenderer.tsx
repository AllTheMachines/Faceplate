...
interface MonoProps {
  config: LUFSMomentaryMonoElementConfig
}

function DefaultLUFSMomentaryMonoRenderer({ config }: MonoProps) {
...
export function LUFSMomentaryMonoRenderer({ config }: MonoProps) {
  if (config.styleId) {
    return <StyledMeterRenderer config={config} />
  }
  return <DefaultLUFSMomentaryMonoRenderer config={config} />
}

interface StereoProps {
  config: LUFSMomentaryStereoElementConfig
}

function DefaultLUFSMomentaryStereoRenderer({ config }: StereoProps) {
...
export function LUFSMomentaryStereoRenderer({ config }: StereoProps) {
  if (config.styleId) {
  ...
  return <DefaultLUFSMomentaryStereoRenderer config={config} />
}
