...
interface MonoProps {
  config: LUFSIntegratedMonoElementConfig
}

function DefaultLUFSIntegratedMonoRenderer({ config }: MonoProps) {
...
export function LUFSIntegratedMonoRenderer({ config }: MonoProps) {
  if (config.styleId) {
    return <StyledMeterRenderer config={config} />
  }
  return <DefaultLUFSIntegratedMonoRenderer config={config} />
}

interface StereoProps {
  config: LUFSIntegratedStereoElementConfig
}

function DefaultLUFSIntegratedStereoRenderer({ config }: StereoProps) {
...
export function LUFSIntegratedStereoRenderer({ config }: StereoProps) {
  if (config.styleId) {
  ...
  return <DefaultLUFSIntegratedStereoRenderer config={config} />
}
