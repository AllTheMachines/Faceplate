...
interface MonoProps {
  config: LUFSShorttermMonoElementConfig
}

function DefaultLUFSShorttermMonoRenderer({ config }: MonoProps) {
...
export function LUFSShorttermMonoRenderer({ config }: MonoProps) {
  if (config.styleId) {
    return <StyledMeterRenderer config={config} />
  }
  return <DefaultLUFSShorttermMonoRenderer config={config} />
}

interface StereoProps {
  config: LUFSShorttermStereoElementConfig
}

function DefaultLUFSShorttermStereoRenderer({ config }: StereoProps) {
...
export function LUFSShorttermStereoRenderer({ config }: StereoProps) {
  if (config.styleId) {
  ...
  return <DefaultLUFSShorttermStereoRenderer config={config} />
}
