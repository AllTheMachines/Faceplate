import type { PercentageDisplayElementConfig } from '../../../../types/elements'
import { formatDisplayValue, truncateValue } from '../../../../utils/valueFormatters'

interface PercentageDisplayRendererProps {
  config: PercentageDisplayElementConfig
}

export function PercentageDisplayRenderer({ config }: PercentageDisplayRendererProps) {
  ...
  return (
    <div
      className="percentagedisplay-element"
      style={{
        width: '100%',
        height: '100%',
