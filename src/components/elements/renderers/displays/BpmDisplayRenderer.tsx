import type { BpmDisplayElementConfig } from '../../../../types/elements'
import { formatDisplayValue, truncateValue } from '../../../../utils/valueFormatters'

interface BpmDisplayRendererProps {
  config: BpmDisplayElementConfig
}

export function BpmDisplayRenderer({ config }: BpmDisplayRendererProps) {
  ...
  // Use raw value if showLabel is false
  const displayText = config.showLabel
    ? formattedValue
    : formattedValue.replace(' BPM', '')
